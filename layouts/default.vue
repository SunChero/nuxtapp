...
<script>
  export default {
    data: () => ({
      ...
      drawer: null,
      items: [
        { icon: 'contacts', text: 'Locations' , link: '/locations' },
        { icon: 'contacts', text: 'organismes' , link: '/organismes' },
        { icon: 'contacts', text: 'Events' , link: '/events' },
        { icon: 'contacts', text: 'Clients' , link: '/clients' },
         { icon: 'contacts', text: 'Sub Categories' , link: '/subcategories' },
